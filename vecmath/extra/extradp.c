...
#ifdef ENABLE_AVX
__attribute__((always_inline)) __m256d xfabs(__m256d x) {
    return _mm256_and_pd(x, _mm256_set1_pd(as_double(0x7FFFFFFFFFFFFFFFll)));
}
__attribute__((always_inline)) __m256d xcopysign(__m256d x, __m256d y) {
...
__attribute__((always_inline)) __m256d xfmin(__m256d x, __m256d y) {
    return _mm256_min_pd(x, y);
}
__attribute__((always_inline)) __m256d xfmax(__m256d x, __m256d y) {
    return _mm256_max_pd(x, y);
}
#endif

#ifdef ENABLE_SSE41
__attribute__((always_inline)) __m128d xfabs(__m128d x) {
    return _mm_and_pd(x, _mm_set1_pd(as_double(0x7FFFFFFFFFFFFFFFll)));
}
__attribute__((always_inline)) __m128d xcopysign(__m128d x, __m128d y) {
...
__attribute__((always_inline)) __m128d xfmin(__m128d x, __m128d y) {
    return _mm_min_pd(x, y);
}
__attribute__((always_inline)) __m128d xfmax(__m128d x, __m128d y) {
